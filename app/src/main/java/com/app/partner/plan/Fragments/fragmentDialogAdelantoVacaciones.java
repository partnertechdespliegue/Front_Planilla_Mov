...
public class fragmentDialogAdelantoVacaciones extends DialogFragment  {
    ...
    private Dialog crearDialog() {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_dialog_adelanto_vacaciones, null);
    ...
    private void obtenerViews(View view) {
        ...
        btnSolicitar = view.findViewById(R.id.buttonSolicitarSoliAdelantoVacaciones);
